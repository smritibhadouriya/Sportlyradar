...
const socialIcons = { twitter: TwitterIcon, instagram: InstagramIcon, facebook: FacebookIcon }

const Footer = memo(() => {
  const { footer } = appConfig

  return (
    <footer className="bg-[#0a3d4f] dark:bg-[#0a1628] text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <div className="text-xl font-bold mb-3 text-[#3387a3]">SportyRadar</div>
            <p className="text-sm text-white/60 leading-relaxed mb-4">{footer.description}</p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-white/50 mb-4">Quick Links</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-white/50 mb-4">Support</h4>
            <ul className="space-y-2">
